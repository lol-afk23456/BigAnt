...
| P04 · verifica sul rilascio | M5A implementa console separata, onboarding, link monouso, password, revoca e sospensione; guida locale disponibile | Creare amministratori nominativi e primo locale nell'ambiente definitivo; definire custodia e recupero degli account amministrativi, consegna sicura dei link e secondo fattore/SSO prima di ampliare il team | Locale creato senza credenziali demo; prova cambio/recupero/revoca sull'URL HTTPS del rilascio; procedura di recupero amministratore documentata |
...
P07 comprende una decisione da chiudere con il provider: il codice attuale registra l’accettazione della richiesta e non ha webhook di recapito/rimbalzo. Per il pilot occorre almeno una riconciliazione documentata; l’automazione degli esiti richiede ulteriore sviluppo. P04 dispone ora della console M5A, richiesta il 24 settembre: [procedura amministrativa](CONSOLE_AMMINISTRATORE.md), controlli e audit sono implementati localmente. La prova sull'ambiente definitivo resta distinta dal cancello locale.
