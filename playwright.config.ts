...
export default defineConfig({
 ...
 webServer:[
  {command:'node apps/api/dist/server.js',url:'http://127.0.0.1:3001/health',reuseExistingServer:false,timeout:60000,env:{DATABASE_URL:database,JWT_SECRET:'e2e-test-secret-with-at-least-32-characters',PORT:'3001',HOST:'127.0.0.1'}},
